...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:24:14 GMT -->
<head>
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="header-faq">
                    <h3 class="f-w-700 mb-3">Quick Questions are answered</h3>
                  </div>
                  <div class="row default-according style-1 faq-accordion" id="accordionoc">
                    <div class="col-xl-8 xl-60 col-lg-6 col-md-7">
                      ...
                      <div class="faq-title">
                        <h3 class="f-w-700 mb-3">Selling And Buying</h3>
                      </div>
                      <div class="card">
                        <div class="card-header">
                          <h5 class="mb-0">
                      ...
                      <div class="faq-title">
                        <h3 class="f-w-700 mb-3">User Accounts</h3>
                      </div>
                      <div class="card">
                        <div class="card-header">
                          <h5 class="mb-0">
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <div class="card card-mb-faq xs-mt-search">
                            <div class="card-header faq-header pb-0">
                              <h4 class="f-w-700">Search articles</h4><i data-feather="help-circle"></i>
                            </div>
                        ...
                        <div class="col-lg-12">
                          <div class="card card-mb-faq">
                            <div class="card-header faq-header pb-0">
                              <h4 class="f-w-700">Navigation</h4><i data-feather="settings"></i>
                            </div>
                            <div class="card-body faq-body">
                        ...
                        <div class="col-lg-12">
                          <div class="card">
                            <div class="card-header faq-header pb-0">
                              <h4 class="f-w-700 d-inline-block">Latest Updates</h4><span class="pull-right d-inline-block">See All</span>
                            </div>
                            <div class="card-body faq-body">
                              <div class="d-flex updates-faq-main">
                                ...
                                <div class="flex-grow-1 updates-bottom-time">
                                  <p class="f-w-600"><a href="#">David Linner   </a>requested money back for a double debit card charge</p>
                                  <p>10 minutes ago</p>
                                </div>
                              </div>
                              <div class="d-flex updates-faq-main">
                                ...
                                <div class="flex-grow-1 updates-bottom-time">
                                  <p class="f-w-600">All sellers have received monthly payouts</p>
                                  <p>2 hours ago</p>
                                </div>
                              </div>
                              <div class="d-flex updates-faq-main">
                                ...
                                <div class="flex-grow-1 updates-bottom-time">
                                  <p class="f-w-600">User Christopher  <a href="#">Wallace  </a> is on hold and awaiting for staff reply</p>
                                  <p>45 minutes ago</p>
                                </div>
                              </div>
                              <div class="d-flex updates-faq-main">
                                ...
                                <div class="flex-grow-1 updates-bottom-time">
                                  <p class="f-w-600">Ticket #43683 has been closed by  <a href="#">Victoria Wilson</a></p>
                                  <p>Dec 7, 11:48</p>
                                </div>
                              </div>
                            </div>
                ...
                <div class="col-lg-12">
                  <div class="header-faq">
                    <h3 class="f-w-700 mb-0">Featured Tutorials</h3>
                  </div>
                  <div class="row">
                ...
                <div class="col-lg-12"> 
                  <div class="header-faq">
                    <h3 class="f-w-600 mb-0">Latest articles and videos</h3>
                  </div>
                  <div class="row">
                            ...
                            <div class="card-body">
                              <div class="d-flex"><i class="m-r-30" data-feather="codepen"></i>
                                <div class="flex-grow-1">
                                  ...
                                  <p>The web is a very big place, and if you are the typical internet base user.</p>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <div class="d-flex"><i class="m-r-30" data-feather="codepen"></i>
                                <div class="flex-grow-1">
                                  <h5 class="f-w-600">Vel illum qu</h5>
                        ...
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <div class="d-flex"><i class="m-r-30" data-feather="codepen"></i>
                                <div class="flex-grow-1">
                                  <h5 class="f-w-600"> Cum sociis natoqu</h5>
                                  <p>Simple demos of frequently asked questions about using the information resources</p>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="card">
                            <div class="card-body">
                              <div class="d-flex"><i class="m-r-30" data-feather="file-text"></i>
                                <div class="flex-grow-1">
                                  <h5 class="f-w-600"> Donec pede justo</h5>
                        ...
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <div class="d-flex"><i class="m-r-30" data-feather="file-text"></i>
                                <div class="flex-grow-1">
                                  <h5 class="f-w-600"> Nam quam nunc</h5>
...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:24:15 GMT -->
</html>