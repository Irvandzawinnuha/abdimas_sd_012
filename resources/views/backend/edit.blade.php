        ...
        <form action="{{ route('foto.update', $foto->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div class="position-relative">
                    <input type="text" class="form-control flatpickr" id="created_at" name="created_at" 
                        value="{{ $foto->created_at->format('Y-m-d') }}" required readonly style="background-color: white;">
            ...
            <div class="mb-4">
                ...
                <div class="mt-3">
                    ...
                    <img src="{{ asset('storage/' . $foto->foto) }}" alt="Foto" class="img-preview">
                </div>
            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        flatpickr(".flatpickr", {
            ...
            altInput: true,
            altFormat: "l, d F Y",
            defaultDate: "{{ $foto->created_at->format('Y-m-d') }}",
            locale: {
                firstDayOfWeek: 1,
                weekdays: {
