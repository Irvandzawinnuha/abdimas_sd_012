...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:22:31 GMT -->
<head>
              ...
              <div class="col-sm-12">
                <div class="card" id="default">
                  <div class="card-header card-no-border pb-0">
                    <h3 class="mb-1">Default buttons</h3>
                    <p class="mb-0 mt-1">Bootstrap state buttons</p>
                  </div>
                  <div class="card-body btn-showcase">
                    ...
                    <button class="btn btn-info text-light" type="button" data-bs-toggle="tooltip" title="btn btn-info">info Button</button>
                    <button class="btn btn-success" type="button" data-bs-toggle="tooltip" title="btn btn-success">success Button</button>
                    <button class="btn btn-warning text-light" type="button" data-bs-toggle="tooltip" title="btn btn-warning">warning Button</button>
                    <button class="btn btn-danger" type="button" data-bs-toggle="tooltip" title="btn btn-danger">danger Button</button>
                    <button class="btn btn-light text-dark" type="button" data-bs-toggle="tooltip" title="btn btn-light">light Button</button>
                  </div>
                </div>
              </div>
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <h3>Flat button</h3>
                    <p class="mb-0 mt-1">
                       Add <code>.btn-square</code> class for flat button</p>
                  </div>
                  <div class="card-body btn-showcase">
                    <button class="btn btn-square btn-primary" type="button" data-bs-toggle="tooltip" title="btn btn-square btn-primary">Primary Button</button>
                    <button class="btn btn-square btn-secondary" type="button" data-bs-toggle="tooltip" title="btn btn-square btn-secondary">Secondary Button</button>
                    <button class="btn btn-square btn-success" type="button" data-bs-toggle="tooltip" title="btn btn-square btn-success">Success Button</button>
                    <button class="btn btn-square btn-info text-white" type="button" data-bs-toggle="tooltip" title="btn btn-square btn-info">Info Button</button>
                    <button class="btn btn-square btn-warning text-white" type="button" data-bs-toggle="tooltip" title="btn btn-square btn-warning">Warning Button</button>
                    <button class="btn btn-square btn-danger" type="button" data-bs-toggle="tooltip" title="btn btn-square btn-danger">Danger Button</button>
                    <button class="btn btn-square btn-light text-dark" type="button" data-bs-toggle="tooltip" title="btn btn-square btn-light">Light Button</button>
                  </div>
                </div>
              </div>
              <div class="col-sm-12">
                <div class="card"> 
                  <div class="card-header card-no-border pb-0"> 
                    <h3>Edge buttons </h3>
                    <p class="mb-0 mt-1">
                       Add <code>.btn-pill</code> class for edge button</p>
                  </div>
                  <div class="card-body btn-showcase">
                    <button class="btn btn-pill btn-primary" type="button" data-bs-toggle="tooltip" title="btn btn-pill btn-primary">Primary Button</button>
                    <button class="btn btn-pill btn-secondary" type="button" data-bs-toggle="tooltip" title="btn btn-pill btn-secondary">Secondary Button</button>
                    <button class="btn btn-pill btn-success" data-bs-toggle="tooltip" title="btn btn-pill btn-success">Success Button</button>
                    <button class="btn btn-pill btn-info text-white" type="button" data-bs-toggle="tooltip" title="btn btn-pill btn-info">Info Button</button>
                    <button class="btn btn-pill btn-warning text-white" type="button" data-bs-toggle="tooltip" title="btn btn-pill btn-warning">Warning Button</button>
                    <button class="btn btn-pill btn-danger" type="button" data-bs-toggle="tooltip" title="btn btn-pill btn-danger">Danger Button</button>
                    <button class="btn btn-pill btn-light text-dark" type="button" data-bs-toggle="tooltip" title="btn btn-pill btn-light">Light Button</button>
                  </div>
                </div>
              </div>
              <div class="col-sm-12">
                <div class="card"> 
                  ...
                  <div class="card-body btn-group-showcase">  
                    <div class="row">
                      ...
                      <div class="col-xxl-4 col-md-6 col-sm-12">
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <button class="btn btn-info text-white" type="button">Left</button>
                          <button class="btn btn-info text-white" type="button">Middle</button>
                          <button class="btn btn-info text-white" type="button">Right</button>
                        </div>
                      </div>
                      <div class="col-xxl-4 col-md-6 col-sm-12">
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <button class="btn btn-warning text-white" type="button">Left</button>
                          <button class="btn btn-warning text-white" type="button">Middle</button>
                          <button class="btn btn-warning text-white" type="button">Right</button>
                        </div>
                      </div>
                      <div class="col-xxl-4 col-md-6 col-sm-12">
                        <div class="btn-group" role="group" aria-label="Basic example">
                      ...
                      <div class="col-xxl-4 col-md-6 col-sm-12">
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <button class="btn btn-light font-dark" type="button">Left</button>
                          <button class="btn btn-light font-dark" type="button">Middle</button>
                          <button class="btn btn-light font-dark" type="button">Right</button>
                        </div>
                      </div>
              ...
              <div class="col-sm-12"> 
                <div class="card"> 
                  <div class="card-header card-no-border pb-0">      
                    <h3>Large buttons</h3>
                    <p class="mb-0 mt-1">
                       Add <code>.btn-lg </code>class for large size buttons.</p>
                  </div>
                  <div class="card-body btn-showcase">
                    ...
                    <button class="btn btn-info btn-lg text-light" type="button" data-bs-toggle="tooltip" title="btn btn-info btn-lg">info Button</button>
                    ...
                    <button class="btn btn-warning btn-lg text-light" type="button" data-bs-toggle="tooltip" title="btn btn-warning btn-lg">warning Button</button>
                    <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="tooltip" title="btn btn-danger btn-lg">danger Button</button>
                    <button class="btn btn-light text-dark btn-lg" type="button" data-bs-toggle="tooltip" title="btn btn-light btn-lg">light Button</button>
                  </div>
                </div>
              </div>
              <div class="col-sm-12"> 
                <div class="card"> 
                  <div class="card-header card-no-border pb-0"> 
                    <h3>Small buttons </h3>
                    <p class="mb-0 mt-1">Add<code>.btn-sm</code> class for small size buttons</p>
                  </div>
                  <div class="card-body btn-showcase">
                    <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="tooltip" title="btn btn-primary btn-sm">Primary Button</button>
                    <button class="btn btn-secondary btn-sm" type="button" data-bs-toggle="tooltip" title="btn btn-secondary btn-sm">Secondary Button</button>
                    <button class="btn btn-success btn-sm" type="button" data-bs-toggle="tooltip" title="btn btn-success btn-sm">Success Button</button>
                    <button class="btn btn-info btn-sm text-light" type="button" data-bs-toggle="tooltip" title="btn btn-info btn-sm">Info Button</button>
                    <button class="btn btn-warning btn-sm text-light" type="button" data-bs-toggle="tooltip" title="btn btn-warning btn-sm">Warning Button</button>
                    <button class="btn btn-danger btn-sm" type="button" data-bs-toggle="tooltip" title="btn btn-danger btn-sm">Danger Button</button>
                    <button class="btn btn-light text-dark btn-sm" type="button" data-bs-toggle="tooltip" title="btn btn-light btn-sm">Light Button</button>
                  </div>
                </div>
              </div>
              <div class="col-sm-12"> 
                <div class="card"> 
                  <div class="card-header card-no-border pb-0"> 
                    ...
                    <p class="mb-0 mt-1">
                       Add <code>.active </code>class for active state.</p>
                  </div>
                  <div class="card-body btn-showcase">
                    <button class="btn btn-primary active" type="button" data-bs-toggle="tooltip" title="btn btn-primary active">Active</button>
                    <button class="btn btn-secondary active" type="button" data-bs-toggle="tooltip" title="btn btn-secondary active">Active</button>
                    <button class="btn btn-success active" type="button" data-bs-toggle="tooltip" title="btn btn-success active">Active</button>
                    <button class="btn btn-info active text-light" type="button" data-bs-toggle="tooltip" title="btn btn-info active">Active</button>
                    <button class="btn btn-warning active text-light" type="button" data-bs-toggle="tooltip" title="btn btn-warning active">Active</button>
                    <button class="btn btn-danger active text-light" type="button" data-bs-toggle="tooltip" title="btn btn-danger active">Active</button>
                    <button class="btn btn-light active text-dark" type="button" data-bs-toggle="tooltip" title="btn btn-light active">Active</button>
                  </div>
                </div>
              </div>
              <div class="col-sm-12"> 
                <div class="card"> 
                  <div class="card-header card-no-border pb-0"> 
                    ...
                    <p class="mb-0 mt-1">
                       Add   <code>.disabled   </code>class or  <code>disabled="disabled"  </code>attribute for disabled button         </p>
                  </div>
                  <div class="card-body btn-showcase">
                    ...
                    <button class="btn btn-info disabled text-light" type="button">Disabled</button>
                    <button class="btn btn-warning disabled text-light" type="button">Disabled</button>
                    <button class="btn btn-danger disabled" type="button">Disabled</button>
                    <button class="btn btn-light text-dark disabled" type="button">Disabled</button>
                  </div>
                </div>
              </div>
              <div class="col-sm-12">
                <div class="card"> 
                  <div class="card-header card-no-border pb-0"> 
                    ...
                    <p class="mb-0 mt-1">
                       Add <code>.btn-outline-*</code> class for border button</p>
                  </div>
                  <div class="card-body btn-showcase">
                    <button class="btn btn-outline-primary" type="button" data-bs-toggle="tooltip" title="btn btn-outline-primary btn-lg">Primary Button</button>
                    <button class="btn btn-outline-secondary" type="button" data-bs-toggle="tooltip" title="btn btn-outline-secondary btn-lg">Secondary Button</button>
                    <button class="btn btn-outline-info" type="button" data-bs-toggle="tooltip" title="btn btn-outline-info btn-lg">Info Button</button>
                    <button class="btn btn-outline-warning" type="button" data-bs-toggle="tooltip" title="btn btn-outline-warning btn-lg">Warning Button</button>
                    <button class="btn btn-outline-danger" type="button" data-bs-toggle="tooltip" title="btn btn-outline-danger btn-lg">Danger Button</button>
                    <button class="btn btn-outline-light text-dark" type="button" data-bs-toggle="tooltip" title="btn btn-outline-light btn-lg">Light Button</button>
                  </div>
                </div>
              </div>
              <div class="col-sm-12"> 
                <div class="card"> 
                  <div class="card-header card-no-border pb-0"> 
                    <h3>Bold border outline button </h3>
                    <p class="mb-0 mt-1">
                       Add <code>.btn-outline-*-2x </code>class for bold outline.</p>
                  </div>
                  <div class="card-body btn-showcase">
                    <button class="btn btn-outline-primary-2x" type="button" data-bs-toggle="tooltip" title="btn btn-outline-primary-2x">Primary Button</button>
                    <button class="btn btn-outline-secondary-2x" type="button" data-bs-toggle="tooltip" title="btn btn-outline-primary-2x">secondary Button</button>
                    <button class="btn btn-outline-info-2x" type="button" data-bs-toggle="tooltip" title="btn btn-outline-primary-2x">info Button</button>
                    <button class="btn btn-outline-warning-2x" type="button" data-bs-toggle="tooltip" title="btn btn-outline-primary-2x">warning Button</button>
                    <button class="btn btn-outline-danger-2x" type="button" data-bs-toggle="tooltip" title="btn btn-outline-primary-2x">danger Button</button>
                    <button class="btn btn-outline-light-2x text-dark" type="button" data-bs-toggle="tooltip" title="btn btn-outline-primary-2x">light Button</button>
                  </div>
                </div>
              </div>
            </div>
