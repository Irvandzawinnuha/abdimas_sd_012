...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/form-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:23:32 GMT -->
<head>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    ...
                    <p class="mt-1 mb-0">
                       If your form layout allows it, you can swap the <code>.{valid|invalid}</code>-feedback classes for</p>
                  </div>
                  <div class="card-body">
                    <form class="row g-3 needs-validation custom-input tooltip-valid validation-forms" novalidate="">
              ...
              <div class="col-xl-6 mb-lg-3">
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    ...
                    <p class="mt-1 mb-0">
                       Not interested in custom validation feedback messages or writing JavaScript to change form behaviors?</p>
                  </div>
              ...
              <div class="col-xl-6">
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    ...
                    <p class="mt-1 mb-0">
                       Custom feedback styles apply custom colors, borders and background icons to better communicate feedback.</p>
                  </div>
                  <div class="card-body">
