...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/gallery-with-description.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:24:12 GMT -->
<head>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <h3>IMAGE GALLERY WITH DESCRIPTION</h3>
                  </div>
