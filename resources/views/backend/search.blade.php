...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/search.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:22:30 GMT -->
<head>
                  ...
                  <div class="card-body">
                    <div class="text-center">
                      <ul class="nav nav-tabs search-list" id="top-tab" role="tablist">
                        ...
                        <li class="nav-item bg-light-success"><a class="nav-link text-success" id="setting-link" data-bs-toggle="tab" href="#setting-link" role="tab" aria-selected="false">Settings</a></li>
                        <li class="nav-item bg-light-secondary"><a class="nav-link text-secondary" id="tools-links" data-bs-toggle="tab" href="#tools-links" role="tab" aria-selected="false">Tools</a></li>
                      </ul>
                    </div>
                    <div class="tab-content" id="top-tabContent">
                      <div class="search-links tab-pane fade show active" id="all-links" role="tabpanel" aria-labelledby="all-link">
                        <div class="row">
                          <div class="col-xxl-8 col-xl-6 box-col-12">
                            <h6 class="f-w-700">Search result for "Pixelstrap"</h6>
                            ...
                            <div class="info-block"><a href="#">https://themeforest.net/user/pixelstrap/portfolio</a>
                              ...
                              <p>Admiro introduces a IELTS Coaching, TOEFL Coaching, GRE Coaching, GMAT Coaching, SAT Coaching in Surat.</p>
                              <div class="star-ratings">
                                <ul class="search-info">
                                  <li><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i><i class="fa-regular fa-star"></i></li>
                                  <li>3 stars</li>
                                  <li>590 votes</li>
                                  <li>Theme</li>
                                </ul>
                      ...
                      <div class="tab-pane fade" id="image-links" role="tabpanel" aria-labelledby="image-link">
                        <div>
                          <h6 class="mb-2 f-w-700">About 12,120 results (0.50 seconds)</h6>
                          <div class="my-gallery row gallery-with-description mb-0" id="aniimated-thumbnials" itemscope="">
                      ...
                      <div class="tab-pane fade" id="video-links" role="tabpanel" aria-labelledby="video-link">
                        <div class="row">
                          <div class="col-xxl-6 box-col-12">
                            <h6 class="my-3 f-w-700">About 6,000 results (0.60 seconds)</h6>
...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/search.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:22:31 GMT -->
</html>