...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/feather_icon.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:23:21 GMT -->
<head>
  ...
  <body> 
              ...
              <div class="col-sm-12">
                <div class="card">  
                  <div class="card-header card-no-border pb-0">
                    <h3 class="f-w-700">Feather Icon </h3>
                  </div>
                  <div class="card-body">
                    <div class="row icon-event feather-icons icon-lists">
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"><i data-feather="activity"></i>
                        <h5 class="mt-0">activity </h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"><i data-feather="airplay"></i>
                        <h5 class="mt-0">airplay</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="alert-circle"></i>
                        <h5 class="mt-0">alert-circle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="alert-octagon"></i>
                        <h5 class="mt-0">alert-octagon</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="alert-triangle"></i>
                        <h5 class="mt-0">alert-triangle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="align-center"></i>
                        <h5 class="mt-0">align-center</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="align-justify"></i>
                        <h5 class="mt-0">align-justify</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="align-left"></i>
                        <h5 class="mt-0">align-left</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="align-right"></i>
                        <h5 class="mt-0">align-right</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="anchor"></i>
                        <h5 class="mt-0">anchor</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"><i data-feather="aperture"></i>
                        <h5 class="mt-0">aperture</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="archive"></i>
                        <h5 class="mt-0">archive</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-down-circle"></i>
                        <h5 class="mt-0">arrow-down-circle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-down-left"></i>
                        <h5 class="mt-0">arrow-down-left</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-down-right"></i>
                        <h5 class="mt-0">arrow-down-right    </h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-down"></i>
                        <h5 class="mt-0">arrow-down</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-left-circle"></i>
                        <h5 class="mt-0">arrow-left-circle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"><i data-feather="arrow-left"></i>
                        <h5 class="mt-0">arrow-left</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-right-circle"></i>
                        <h5 class="mt-0">arrow-right-circle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-right"></i>
                        <h5 class="mt-0">arrow-right</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-up-circle"></i>
                        <h5 class="mt-0">arrow-up-circle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-up-left"></i>
                        <h5 class="mt-0">arrow-up-left</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-up-right"></i>
                        <h5 class="mt-0">arrow-up-right</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="arrow-up"></i>
                        <h5 class="mt-0 mb-2">arrow-up</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="at-sign"></i>
                        <h5 class="mt-0">at-sign</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="award"></i>
                        <h5 class="mt-0">award</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="bar-chart-2"></i>
                        <h5 class="mt-0">bar-chart-2</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lh-4 col-md-6 icons-item"> <i data-feather="bar-chart"></i>
                        <h5 class="mt-0">bar-chart</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="battery-charging"></i>
                        <h5 class="mt-0">battery-charging</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="battery"></i>
                        <h5 class="mt-0">battery</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="bell-off"></i>
                        <h5 class="mt-0">bell-off </h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="bell"></i>
                        <h5 class="mt-0">bell</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"><i data-feather="bluetooth"></i>
                        <h5 class="mt-0">bluetooth</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="bold"></i>
                        <h5 class="mt-0">bold    </h5>
                      </div>
                      <div class="col-12 col-xxl-12 col-lg-4 col-md-6 icons-item"> <i data-feather="book-open"></i>
                        <h5 class="mt-0">book-open</h5>
                      </div>
                      <div class="col-12 col-xxl-12 col-lg-4 col-md-6 icons-item"><i data-feather="book"></i>
                        <h5 class="mt-0">book</h5>
                      </div>
                      <div class="col-12 col-xxl-12 col-lg-4 col-md-6 icons-item"> <i data-feather="bookmark"></i>
                        <h5 class="mt-0">bookmark</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="box"></i>
                        <h5 class="mt-0">box</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="briefcase"></i>
                        <h5 class="mt-0">briefcase</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="calendar"></i>
                        <h5 class="mt-0">calendar</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"><i data-feather="camera-off"></i>
                        <h5 class="mt-0">camera-off</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="camera"></i>
                        <h5 class="mt-0">camera</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"><i data-feather="cast"></i>
                        <h5 class="mt-0">cast</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="check-circle"></i>
                        <h5 class="mt-0">check-circle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="check-square"></i>
                        <h5 class="mt-0">check-square</h5>
                      </div>
                      <div class="col-12 colxxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="check"></i>
                        <h5 class="mt-0">check</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="chevron-down"></i>
                        <h5 class="mt-0">chevron-down</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="chevron-right"></i>
                        <h5 class="mt-0">chevron-right</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="chevron-up"></i>
                        <h5 class="mt-0">chevron-up</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="chevrons-down"></i>
                        <h5 class="mt-0">chevrons-down</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="chevrons-left"></i>
                        <h5 class="mt-0">chevrons-left</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="chevrons-right"></i>
                        <h5 class="mt-0">chevrons-right</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="chevrons-up"></i>
                        <h5 class="mt-0">chevrons-up</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="chrome"></i>
                        <h5 class="mt-0">chrome</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="circle"></i>
                        <h5 class="mt-0">circle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="clipboard"></i>
                        <h5 class="mt-0">clipboard</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="clock"></i>
                        <h5 class="mt-0">clock</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="cloud-drizzle"></i>
                        <h5 class="mt-0">cloud-drizzle</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="cloud-lightning"></i>
                        <h5 class="mt-0">cloud-lightning</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="cloud-off"></i>
                        <h5 class="mt-0">cloud-off</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="cloud-rain"></i>
                        <h5 class="mt-0">cloud-rain</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="cloud-snow"></i>
                        <h5 class="mt-0">cloud-snow</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="cloud"></i>
                        <h5 class="mt-0">cloud</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="code"></i>
                        <h5 class="mt-0">code</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="codepen"></i>
                        <h5 class="mt-0">codepen</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="coffee"></i>
                        <h5 class="mt-0">coffee</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="command"></i>
                        <h5 class="mt-0">command</h5>
                      </div>
                      <div class="col-12 col-xxol-2 col-lg-4 col-md-6 icons-item"> <i data-feather="compass"></i>
                        <h5 class="mt-0">compass</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="copy"></i>
                        <h5 class="mt-0">copy</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="corner-down-left"></i>
                        <h5 class="mt-0">corner-down-left</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="corner-down-right"></i>
                        <h5 class="mt-0">corner-down-right</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="corner-left-down"></i>
                        <h5 class="mt-0">corner-left-down</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="corner-left-up"></i>
                        <h5 class="mt-0">corner-left-up</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="corner-right-down"></i>
                        <h5 class="mt-0">corner-right-down</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="corner-right-up"></i>
                        <h5 class="mt-0">corner-right-up</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="corner-up-left"></i>
                        <h5 class="mt-0">corner-up-left</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="corner-up-right"></i>
                        <h5 class="mt-0">corner-up-right</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="cpu"></i>
                        <h5 class="mt-0">cpu</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="credit-card"></i>
                        <h5 class="mt-0">credit-card</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="crop"></i>
                        <h5 class="mt-0">crop</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="crosshair"></i>
                        <h5 class="mt-0">crosshair</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"><i data-feather="database"></i>
                        <h5 class="mt-0">database</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="delete"></i>
                        <h5 class="mt-0">delete</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="disc"></i>
                        <h5 class="mt-0">disc</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="dollar-sign"></i>
                        <h5 class="mt-0">dollar-sign</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="download-cloud"></i>
                        <h5 class="mt-0">download-cloud</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="download"></i>
                        <h5 class="mt-0">download</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="droplet"></i>
                        <h5 class="mt-0">droplet</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="edit-2"></i>
                        <h5 class="mt-0">edit-2</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="edit-3"></i>
                        <h5 class="mt-0">edit-3</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="eye"></i>
                        <h5 class="mt-0">eye</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="facebook"></i>
                        <h5 class="mt-0">facebook</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="fast-forward"></i>
                        <h5 class="mt-0">fast-forward</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="feather"></i>
                        <h5 class="mt-0">feather</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="file-minus"></i>
                        <h5 class="mt-0">file-minus</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="file-plus"></i>
                        <h5 class="mt-0">file-plus</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="file-text"></i>
                        <h5 class="mt-0">file-text</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="file"></i>
                        <h5 class="mt-0">file</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="film"></i>
                        <h5 class="mt-0">film</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="filter"></i>
                        <h5 class="mt-0">filter</h5>
                      </div>
                      <div class="col-12 col-xxl-2 col-lg-4 col-md-6 icons-item"> <i data-feather="youtube"></i>
    ...
    <!-- icon_notify-->
    <script src="../assets/js/icon/icons-notify.js"></script>
    <!-- page_feather_icon-->
    <script src="../assets/js/icon/feather-icon-clipart.js"></script>
    <!-- custom script -->
    <script src="../assets/js/script.js"></script>
  </body>

<!-- Mirrored from admin.pixelstrap.net/admiro/template/feather_icon.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:23:22 GMT -->
</html>