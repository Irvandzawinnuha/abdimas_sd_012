...
<!-- Mirrored from admin.pixelstrap.net/admiro/template/email-header.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 17:24:06 GMT -->
<head>
                    ...
                    <table style="margin: 0 auto; margin-bottom: 30px">
                      <tbody>
                        <tr class="logo-sec" style="display: flex; align-items: center; justify-content: space-between; width: 650px;">
                          <td><img class="img-fluid for-light" src="../assets/images/other-images/logo-login.png" alt=""></td>
              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p>you forgot your password for Admiro Admin. If this is true, click below to reset your password.</p>
                    <p style="text-align: center"><a href="reset-password.html" style="padding: 10px; background-color:#308e87; color: #fff; display: inline-block; border-radius:30px; font-weight:700; padding:0.6rem 1.75rem;">Reset Password</a></p>
              ...
              <tbody>       
                <tr style="text-align: center">
                  <td> 
                    ...
                    <p style="color: #999; margin-bottom: 0">Don't Like These Emails?<a href="#" style="color: #308e87">Unsubscribe</a></p>
                    <p style="color: #999; margin-bottom: 0">Powered By Admiro Admin</p>
                  </td>
                </tr>
              </tbody>
            </table>
