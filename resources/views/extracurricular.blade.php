...
<nav class="navbar">
    ...
    <div class="container" style="text-align: left; margin-left: 20px;">
        ...
        <div class="galeri-kategori" style="display: flex; flex-direction: column; align-items: flex-start;">
            <h3 style="font-size: 24px; font-weight: bold; margin-bottom: 15px;">Pramuka</h3>
            <div class="galeri-items" style="display: flex; gap: 15px; flex-wrap: wrap;">
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto1.jpg" alt="Pramuka" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto2.jpg" alt="Pramuka" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
            </div>
...
<!--Paskibraka-->
<div class="galeri-kategori" style="display: flex; flex-direction: column; align-items: flex-start;">
            <h3 style="font-size: 24px; font-weight: bold; margin-bottom: 15px;">Paskibraka</h3>
            <div class="galeri-items" style="display: flex; gap: 15px; flex-wrap: wrap;">
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto1.jpg" alt="Paskibraka" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto2.jpg" alt="Paskibraka" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
            </div>
            <div class="lihat-selengkapnya" style="margin-top: 10px;">
                <button style="background-color: #007bff; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">
...
<!--Sepak Bola-->
<div class="galeri-kategori" style="display: flex; flex-direction: column; align-items: flex-start;">
            <h3 style="font-size: 24px; font-weight: bold; margin-bottom: 15px;">Sepak Bola</h3>
            <div class="galeri-items" style="display: flex; gap: 15px; flex-wrap: wrap;">
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto1.jpg" alt="Sepak Bola" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto2.jpg" alt="Sepak Bola" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
            </div>
            <div class="lihat-selengkapnya" style="margin-top: 10px;">
                <button style="background-color: #007bff; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">
...
<!--Rohis-->
<div class="galeri-kategori" style="display: flex; flex-direction: column; align-items: flex-start;">
            <h3 style="font-size: 24px; font-weight: bold; margin-bottom: 15px;">Rohis</h3>
            <div class="galeri-items" style="display: flex; gap: 15px; flex-wrap: wrap;">
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto1.jpg" alt="Rohis" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto2.jpg" alt="Rohis" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
            </div>
            <div class="lihat-selengkapnya" style="margin-top: 10px;">
                <button style="background-color: #007bff; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">
...
<!--Marching Band-->
<div class="galeri-kategori" style="display: flex; flex-direction: column; align-items: flex-start;">
            <h3 style="font-size: 24px; font-weight: bold; margin-bottom: 15px;">Marching Band</h3>
            <div class="galeri-items" style="display: flex; gap: 15px; flex-wrap: wrap;">
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto1.jpg" alt="Marching Band" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
                <div class="galeri-item" style="margin-bottom: 10px;">
                    <img src="https://example.com/foto2.jpg" alt="Marching Band" style="width: 150px; height: 100px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                </div>
            </div>
            <div class="lihat-selengkapnya" style="margin-top: 10px;">
                <button style="background-color: #007bff; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">
