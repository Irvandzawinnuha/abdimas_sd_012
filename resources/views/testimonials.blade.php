...
<!-- Bagian Testimoni -->
<div class="testimonials-section" style="padding: 50px 0; background-color: #f9f9f9;">
    <div class="container" style = "display: block;">
        <h2 class="section-title" style="text-align: center; font-size: 2rem; margin-bottom: 20px;">Testimoni</h2>
        <p>SDN 012 Babakan Ciparay</p>
        <div class="testimonials">
            <div class="testimonial-item" style="display: flex; align-items: center; margin-bottom: 20px; gap: 20px;">
                <img src="{{ asset('images/andi-pratama.jpg') }}" alt="Andi Pratama" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover;">
                <div>
                    <p style="font-style: italic;">"Sekolah ini adalah tempat di mana mimpi saya mulai terbentuk. Bukan hanya mendapatkan pendidikan terbaik, tetapi juga nilai-nilai kehidupan yang membentuk karakter saya hingga saat ini. Saya sangat bangga menjadi bagian dari keluarga besar sekolah ini."</p>
            ...
            <div class="testimonial-item" style="display: flex; align-items: center; margin-bottom: 20px; gap: 20px;">
                <img src="{{ asset('images/sarah-amelia.jpg') }}" alt="Sarah Amelia" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover;">
                <div>
                    <p style="font-style: italic;">"Saya berterima kasih kepada sekolah ini karena telah memberi saya pengalaman belajar yang menyenangkan dan penuh tantangan. Guru-gurunya sangat peduli, dan suasananya mendukung pertumbuhan siswa secara akademik maupun personal."</p>
            ...
            <div class="testimonial-item" style="display: flex; align-items: center; margin-bottom: 20px; gap: 20px;">
                <img src="{{ asset('images/budi-santoso.jpg') }}" alt="Budi Santoso" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover;">
                <div>
                    <p style="font-style: italic;">"Anak saya menjadi lebih percaya diri dan bersemangat belajar sejak masuk ke sekolah ini. Guru-guru di sini tidak hanya memberikan ilmu pengetahuan, tetapi juga membangun karakter positif. Saya sangat bersyukur anak saya bisa belajar di sini."</p>
